...
export default function Settings() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-gray-100 border border-gray-300 rounded py-6 px-16 space-y-6">
        <div>
          <h2 className="font-semibold text-lg">Notifications</h2>

          <p className="text-sm text-gray-600">Configure your work reminders.</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          <label className="font-medium whitespace-nowrap">Remind me after</label>
        ...
        {saved && <p className="text-green-600">Settings saved</p>}
      </div>
    </div>
  );
}